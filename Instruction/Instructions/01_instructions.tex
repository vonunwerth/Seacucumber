...
\begin{itemize}
	...
	\item The plugin folder has to be created in the following directory(neo4j/default.graphdb/plugins). You need this for your \glqq  Neo4j - Procedures\grqq{}.
	\newpage
	\item After downloading and installing the Software \glqq ItelliJ IDEA\grqq{} opens and is ready for use. The following window opens. \\
	\begin{center}
		\includegraphics[width=4.2cm]{common/IntelliJstart.png}\setlength{\unitlength}{1mm}
	\end{center}

	\item You click on \glqq Check out from Version Control\grqq{} and a window with the name \glqq Clone Repository\grqq{} will open. \\
	...
	\item --------------braucht man das? klappt auch ohne.-----------------
...
\begin{itemize}
	...
	\item You have to write a constructor in your class. The constructor's name has to be the same as the classname. The following structure can be used: \\ %Felix anpassen
